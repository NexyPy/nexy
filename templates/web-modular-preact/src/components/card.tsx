...
function Card() {
    return (
        ...
        >
            <p className="text-white/70 text-xs border border-white/40 rounded-full w-fit px-2 py-1">This is Preact component</p>
            <div className="flex justify-center items-center">
                <figure>
                    <img src="/public/preact.png" alt="preact" className="size-32"/>
                </figure>
            </div>
            <Counter />
        </div>
