...
SQLModel es el ORM recomendado para nuevos proyectos de Nexy: los modelos de Pydantic también funcionan como modelos de bases de datos.
...
Utilice Alambique (configurado manualmente o mediante `nx migrate`):
