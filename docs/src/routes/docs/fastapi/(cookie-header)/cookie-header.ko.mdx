...
헤더 이름은 기본적으로 밑줄로 하이픈이 포함된 소문자입니다. 사용자 정의 헤더 이름에는 `alias`를 사용하십시오.
```python
---
from fastapi import Header
...
- [useCookies hook](/docs/hooks/useCookies) — 템플릿에서 쿠키를 읽는 데 사용됩니다.
- [Session config](/docs/config/session) — 세션 미들웨어 설정